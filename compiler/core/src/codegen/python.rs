...
impl<'a> Codegen<'a, PythonImport> for PythonCodegen<'a> {
    ...
    fn serialize_prelude(&self) -> Option<String> {
        ...
        s.write_line(Some("# pyright: reportIncompatibleVariableOverride=false"));
        s.write_line(Some("# fmt: off"));
        s.write_line(None);
        s.write_line(Some("# This file is autogenerated by ruu."));
        s.write_line(Some("# Do not edit this file directly."));
        s.write_line(None);
    ...
    fn serialize_relationship(
        ...
        PythonImport::with_class(&mut s, &rel_name, vec!["Rule"], |s| {
            ...
            let src_entity = self
                .entities
                .iter()
                .find(|e| e.data.data.name.data == rule.entity_name.data);
